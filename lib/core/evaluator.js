...
var PartialEvaluator = (function PartialEvaluatorClosure() {
  ...
  function NativeImageDecoder(_ref) {
    ...
    var _ref$forceDataSchema = _ref.forceDataSchema;

    var forceDataSchema = _ref$forceDataSchema === undefined ? false : _ref$forceDataSchema;

    var pdfFunctionFactory = _ref.pdfFunctionFactory;
  ...
  NativeImageDecoder.prototype = {
    canDecode: function canDecode(image) {
      return (
        ...
        NativeImageDecoder.isDecodable(image, this.xref, this.resources, this.pdfFunctionFactory)
      );
    },
    decode: function decode(image) {
      var dict = image.dict;
      var colorSpace = dict.get('ColorSpace', 'CS');
      colorSpace = _colorspace.ColorSpace.parse(
        colorSpace,
        this.xref,
        this.resources,
      ...
      return this.handler
        .sendWithPromise('JpegDecode', [image.getIR(this.forceDataSchema), colorSpace.numComps])
        .then(function(_ref2) {
          var data = _ref2.data;
  ...
  NativeImageDecoder.isDecodable = function(image, xref, res, pdfFunctionFactory) {
    ...
    return (
      (cs.numComps === 1 || cs.numComps === 3) && cs.isDefaultDecode(dict.getArray('Decode', 'D'))
    );
  };
  function PartialEvaluator(_ref3) {
    ...
    var idFactory = _ref3.idFactory;

    var fontCache = _ref3.fontCache;

    var builtInCMapCache = _ref3.builtInCMapCache;

    var _ref3$options = _ref3.options;

    var options = _ref3$options === undefined ? null : _ref3$options;

    var pdfFunctionFactory = _ref3.pdfFunctionFactory;
  ...
  PartialEvaluator.prototype = {
    ...
    hasBlendModes: function PartialEvaluator_hasBlendModes(resources) {
      ...
      while (nodes.length) {
        ...
        for (i = 0, ii = xObjectsKeys.length; i < ii; i++) {
          ...
          if (
            (0, _primitives.isDict)(xResources) &&
    ...
    buildPaintImageXObject: function buildPaintImageXObject(_ref4) {
      ...
      var isInline = _ref4$isInline === undefined ? false : _ref4$isInline;

      var operatorList = _ref4.operatorList;

      var cacheKey = _ref4.cacheKey;

      var imageCache = _ref4.imageCache;

      var _ref4$forceDisableNat = _ref4.forceDisableNativeImageDecoder;

      var forceDisableNativeImageDecoder =
        _ref4$forceDisableNat === undefined ? false : _ref4$forceDisableNat;
      ...
      if (
        ...
        !mask &&
        image instanceof _jpeg_stream.JpegStream &&
        NativeImageDecoder.isSupported(image, this.xref, resources, this.pdfFunctionFactory)
      ) {
        return this.handler
          .sendWithPromise('obj', [
            objId,
      ...
      if (
        nativeImageDecoderSupport === _util.NativeImageDecoding.DECODE &&
        (image instanceof _jpeg_stream.JpegStream ||
          mask instanceof _jpeg_stream.JpegStream ||
          softMask instanceof _jpeg_stream.JpegStream)
      ) {
      ...
      _image.PDFImage.buildImage({
        ...
        .then(function(imageObj) {
          ...
          _this2.handler.send(
            'obj',
            [objId, _this2.pageIndex, 'Image', imgData],
            [imgData.data.buffer]
          );
        })
    ...
    handleTilingType: function handleTilingType(
      fn,
      args,
      resources,
      pattern,
    ...
    handleSetFont: function PartialEvaluator_handleSetFont(
      ...
      return this.loadFont(fontName, fontRef, resources)
        .then(function(translated) {
          ...
          return translated
            .loadType3Data(_this4, resources, operatorList, task)
            .then(function() {
              return translated;
            })
            .catch(function(reason) {
    ...
    handleText: function PartialEvaluator_handleText(chars, state) {
      ...
      if (
        font.data &&
        (isAddToPathSet || this.options.disableFontFace || state.fillColorSpace.name === 'Pattern')
      ) {
        var buildPath = function buildPath(fontChar) {
          if (!font.renderer.hasBuiltPath(fontChar)) {
            var path = font.renderer.getPathJs(fontChar);
            _this5.handler.send('commonobj', [
        ...
        switch (key) {
          ...
          case 'Font':
            promise = promise.then(function() {
              return _this6
                .handleSetFont(resources, null, value[0], operatorList, task, stateManager.state)
    ...
    getOperatorList: function getOperatorList(_ref5) {
      ...
      var operatorList = _ref5.operatorList;

      var _ref5$initialState = _ref5.initialState;

      var initialState = _ref5$initialState === undefined ? null : _ref5$initialState;
    ...
    getTextContent: function getTextContent(_ref6) {
      ...
      var _ref6$stateManager = _ref6.stateManager;

      var stateManager = _ref6$stateManager === undefined ? null : _ref6$stateManager;

      var _ref6$normalizeWhites = _ref6.normalizeWhitespace;

      var normalizeWhitespace = _ref6$normalizeWhites === undefined ? false : _ref6$normalizeWhites;

      var _ref6$combineTextItem = _ref6.combineTextItems;

      var combineTextItems = _ref6$combineTextItem === undefined ? false : _ref6$combineTextItem;

      var sink = _ref6.sink;

      var _ref6$seenStyles = _ref6.seenStyles;

      var seenStyles = _ref6$seenStyles === undefined ? Object.create(null) : _ref6$seenStyles;
      ...
      function ensureTextContentItem() {
        ...
        if (
          font.isType3Font &&
          textState.fontMatrix !== _util.FONT_IDENTITY_MATRIX &&
        ...
        if ((0, _primitives.isName)(encoding)) {
          ...
          for (var i = 0, ii = keys.length; i < ii; i++) {
            ...
            if ((0, _primitives.isName)(entry)) {
              ...
              var diffBuf = new Array(diffLength);
