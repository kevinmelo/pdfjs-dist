...
var Font = (function FontClosure() {
  ...
  function isProblematicUnicodeLocation(code) {
    ...
    var j = ProblematicCharRanges.length - 1;
    while (i < j) {
      var c = (i + j + 1) >> 1;
  ...
  Font.prototype = {
    ...
    fallbackToSystemFont: function Font_fallbackToSystemFont() {
      ...
      if (
        ...
        if (/Arial-?Black/i.test(name)) {
          ...
          var SupplementalGlyphMapForCalibri = (0,
          _standard_fonts.getSupplementalGlyphMapForCalibri)();
    ...
    checkAndRepair: function Font_checkAndRepair(name, font, properties) {
      ...
      function readTrueTypeCollectionData(ttc, fontName) {
        ...
        var numFonts = _readTrueTypeCollecti.numFonts;

        var offsetTable = _readTrueTypeCollecti.offsetTable;
      ...
      if (!isTrueType) {
        if (
          (header.version === 'OTTO' && !(properties.composite && properties.cidToGidMap)) ||
          !tables['head'] ||
          !tables['hhea'] ||
          !tables['maxp'] ||
          !tables['post']
...
var Type1Font = (function Type1FontClosure() {
  ...
  function Type1Font(name, file, properties) {
    ...
    var headerBlockParser = new _type1_parser.Type1Parser(
      headerBlock.stream,
      false,
    ...
    var eexecBlockParser = new _type1_parser.Type1Parser(
      eexecBlock.stream,
      true,
      SEAC_ANALYSIS_ENABLED
    );
