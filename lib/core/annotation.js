...
class AnnotationFactory {
  ...
  static _create(xref, ref, pdfManager, idFactory) {
    ...
    switch (subtype) {
      ...
      case 'Widget':
        let fieldType = (0, _coreUtils.getInheritableProperty)({
          dict,
          key: 'FT'
        });
      ...
      default:
        if (!subtype) {
          ...
          (0, _util.warn)(
            'Unimplemented annotation type "' + subtype + '", ' + 'falling back to base annotation.'
          );
        }
...
class Annotation {
  ...
  getOperatorList(evaluator, task, renderForms) {
    if (!this.appearance) {
      return Promise.resolve(new _operatorList.OperatorList());
    }
    ...
    return resourcesPromise.then(resources => {
      const opList = new _operatorList.OperatorList();
...
class WidgetAnnotation extends Annotation {
  constructor(params) {
    ...
    data.fieldValue = (0, _coreUtils.getInheritableProperty)({
      dict,
      key: 'V',
      getArray: true
    });
    ...
    data.defaultAppearance =
      (0, _coreUtils.getInheritableProperty)({
        dict,
        key: 'DA'
      }) || '';
    const fieldType = (0, _coreUtils.getInheritableProperty)({
      dict,
      key: 'FT'
    });
    ...
    data.fieldFlags = (0, _coreUtils.getInheritableProperty)({
      dict,
      key: 'Ff'
    });
...
class TextWidgetAnnotation extends WidgetAnnotation {
  constructor(params) {
    ...
    let alignment = (0, _coreUtils.getInheritableProperty)({
      dict,
      key: 'Q'
    });
    ...
    let maximumLength = (0, _coreUtils.getInheritableProperty)({
      dict,
      key: 'MaxLen'
    });
    ...
    this.data.comb =
      ...
      !this.hasFieldFlag(_util.AnnotationFieldFlag.FILESELECT) &&
  ...
  getOperatorList(evaluator, task, renderForms) {
    ...
    const operatorList = new _operatorList.OperatorList();
...
class ChoiceWidgetAnnotation extends WidgetAnnotation {
  constructor(params) {
    super(params);
    this.data.options = [];
    const options = (0, _coreUtils.getInheritableProperty)({
      dict: params.dict,
      key: 'Opt'
    });
