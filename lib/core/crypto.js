...
var calculateSHA512 = (function calculateSHA512Closure() {
  ...
  function hash(data, offset, length, mode384) {
    ...
    var b = new Word64(0, 0);

    var c = new Word64(0, 0);
    var d = new Word64(0, 0);

    var e = new Word64(0, 0);

    var f = new Word64(0, 0);
    var g = new Word64(0, 0);

    var h = new Word64(0, 0);
    var t1 = new Word64(0, 0);

    var t2 = new Word64(0, 0);
    var tmp1 = new Word64(0, 0);

    var tmp2 = new Word64(0, 0);
...
var AES128Cipher = (function(_AESBaseCipher) {
  ...
  function AES128Cipher(key) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (AES128Cipher.__proto__ || Object.getPrototypeOf(AES128Cipher)).call(this)
    );
...
var AES256Cipher = (function(_AESBaseCipher2) {
  ...
  function AES256Cipher(key) {
    ...
    var _this2 = _possibleConstructorReturn(
      this,
      (AES256Cipher.__proto__ || Object.getPrototypeOf(AES256Cipher)).call(this)
    );
