...
exports.SVGGraphics = SVGGraphics;
{
  ...
  exports.SVGGraphics = SVGGraphics = class SVGGraphics {
    constructor(commonObjs, objs, forceDataSchema) {
      this.svgFactory = new _displayUtils.DOMSVGFactory();
    ...
    setStrokeColorN(args) {
      this.current.strokeColor = this._makeColorNPattern(args);
    }

    setFillColorN(args) {
      this.current.fillColor = this._makeColorNPattern(args);
    }
