...
var PDFNodeStreamFullReader = (function(_BaseFullReader) {
  ...
  function PDFNodeStreamFullReader(stream) {
    ...
    var _this5 = _possibleConstructorReturn(
      this,
      (PDFNodeStreamFullReader.__proto__ || Object.getPrototypeOf(PDFNodeStreamFullReader)).call(
        this,
        stream
      )
    );
...
var PDFNodeStreamFsFullReader = (function(_BaseFullReader2) {
  ...
  function PDFNodeStreamFsFullReader(stream) {
    ...
    var _this7 = _possibleConstructorReturn(
      this,
      (
        PDFNodeStreamFsFullReader.__proto__ || Object.getPrototypeOf(PDFNodeStreamFsFullReader)
      ).call(this, stream)
    );
...
var PDFNodeStreamFsRangeReader = (function(_BaseRangeReader2) {
  ...
  function PDFNodeStreamFsRangeReader(stream, start, end) {
    ...
    var _this8 = _possibleConstructorReturn(
      this,
      (
        PDFNodeStreamFsRangeReader.__proto__ || Object.getPrototypeOf(PDFNodeStreamFsRangeReader)
      ).call(this, stream)
    );
